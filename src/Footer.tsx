...
function App() {
  return (
    ...
    <div className="upper_container">
        ...
        <img className="img-logo"src="images/Logo.svg" alt="" style="color: white;"/>
    ...
    <div className="lower_container">
            ...
            <div className="footer-col">
                ...
                <ul>
                    <h4>Mobile app</h4>
                    <img className="App-mobile"src="images/qr-code.svg" alt=""/>
                    <div className="QR-CODES">
                        <img src="images/google-play.svg" alt=""/>
                        <img src="images/app-store.svg" alt=""/>
                        <img src="images/appgallery-logo-sk.svg" alt=""/>
                    </div>
                </ul>
            </div>           
        </div>
